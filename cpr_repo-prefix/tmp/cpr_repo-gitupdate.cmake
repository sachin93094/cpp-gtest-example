...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/agent/work/3a1a2f17dc5a16b4/cpr_repo-prefix/src/cpr_repo'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/agent/work/3a1a2f17dc5a16b4/cpr_repo-prefix/src/cpr_repo'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
